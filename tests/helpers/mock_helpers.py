...
class MockHelper:
    ...
    @staticmethod
    def create_mock_eodhd_success_response(
    ...
    @staticmethod
    def create_mock_eodhd_error_response(
        status_code: int = 500, message: str = "Server error"
    ) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def configure_text_processor_mock(
...
class AssertionHelper:
    ...
    @staticmethod
    def assert_article_stored_correctly(
        article_manager, article: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    def assert_chunks_in_chroma(
        chroma_manager, article_hash: str, expected_chunks: List[str]
    ) -> List[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def assert_api_call_logged(
        article_manager, query_type: str, query_value: str
    ) -> None:
        """
    ...
    @staticmethod
    def assert_processing_status(
        article_manager, url_hash: str, expected_status: str
    ) -> None:
        """
        ...
        assert (
            article.get("processing_status") == expected_status
        ), f"Expected status '{expected_status}', got '{article.get('processing_status')}'"

    @staticmethod
    def assert_embedding_status(
        article_manager, url_hash: str, expected_status: str
    ) -> None:
        """
        ...
        assert article is not None, "Article not found"
        assert (
            article.get("embedding_status") == expected_status
