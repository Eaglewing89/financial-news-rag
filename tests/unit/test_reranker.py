...
class TestReRankerCoreOperations:
    ...
    def test_rerank_articles_successful(
        self, create_reranker, reranker_test_articles, test_query
    ):
        ...
        with patch(
            "financial_news_rag.reranker.ReRanker._assess_article_relevance"
        ) as mock_assess:
...
class TestReRankerErrorHandling:
    ...
    def test_rerank_articles_api_error(
        self, create_reranker, reranker_test_articles, test_query
    ):
    ...
    def test_rerank_articles_api_error_specific_exception(
        self, create_reranker, reranker_test_articles, test_query
    ):
    ...
    def test_rerank_articles_malformed_json(
        self, create_reranker, reranker_test_articles, test_query
    ):
    ...
    def test_missing_required_fields(self, create_reranker, test_query):
        ...
        article_missing_content = {"url_hash": "hash4", "title": "Article 4"}
...
class TestReRankerAssessmentLogic:
    ...
    def test_assess_article_relevance_malformed_json_with_regex_fallback(
        ...
        mock_response = MagicMock()
        mock_response.text = (
            'Some text before {"id": "test_hash", "score": 7.2} some text after'
        )
        mock_client.models.generate_content.return_value = mock_response
    ...
    def test_assess_article_relevance_completely_unparseable_response(
        self, create_reranker
    ):
    ...
    def test_assess_article_relevance_content_truncation(self, create_reranker):
        ...
        # Act
        result = reranker._assess_article_relevance(
            query="test query", article_content=long_content, url_hash="test_hash"
        )
    ...
    def test_assess_article_relevance_empty_content_direct(self, create_reranker):
        ...
        # Act
        result = reranker._assess_article_relevance(
            query="test query", article_content="", url_hash="test_hash"
        )
    ...
    def test_assess_article_relevance_whitespace_only_content(self, create_reranker):
        ...
        # Act
        result = reranker._assess_article_relevance(
            query="test query", article_content="   \n\t   ", url_hash="test_hash"
        )
    ...
    def test_assess_article_relevance_integer_score_in_regex(self, create_reranker):
        ...
        # Act
        result = reranker._assess_article_relevance(
            query="test query", article_content="Test content.", url_hash="test_hash"
        )
...
class TestReRankerIntegrationScenarios:
    ...
    def test_identical_scores_maintain_original_order(
        self, create_reranker, test_query
    ):
