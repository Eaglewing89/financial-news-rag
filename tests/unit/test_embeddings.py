...
class TestEmbeddingsGeneratorEmbeddingGeneration:
    ...
    def test_generate_embeddings_success(self, mock_client_cls, test_config, mock_embedding_vector, test_chunks):
...
class TestEmbeddingsGeneratorErrorHandling:
    ...
    def test_mismatched_embedding_count(self, mock_client_cls, test_chunks):
        ...
        mock_result = MagicMock()
        mock_result.embeddings = [mock_embedding_obj]  # Only one embedding for multiple chunks
