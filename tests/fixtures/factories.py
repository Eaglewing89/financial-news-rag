...
class TestScenarioFactory:
    ...
    def create_full_pipeline_scenario(cls) -> Dict[str, Any]:
        ...
        raw_articles = ArticleFactory.create_articles_batch(
            3, source_query_tag="TECHNOLOGY"
        )
    ...
    def create_search_scenario(cls) -> Dict[str, Any]:
        ...
        """
        from .sample_data import ChromaResultsFactory, ChunkFactory
    ...
    def create_embedding_scenario(cls) -> Dict[str, Any]:
        ...
        for i in range(3):
            article = ArticleFactory.create_article_with_status(
                processing_status="SUCCESS", embedding_status="PENDING"
            )
    ...
    def create_error_scenario(cls, error_type: str = "api_error") -> Dict[str, Any]:
        ...
        scenarios = {
            "api_error": {
                "api_response": EODHDResponseFactory.create_error_response(
...
class ConfigDataFactory:
    ...
    @classmethod
    def create_database_path_override(
        cls, custom_path: str = "/custom/path/to/database.db"
    ) -> Dict[str, str]:
    ...
    def create_invalid_json_dimensions(cls) -> Dict[str, str]:
        ...
        return {"EMBEDDINGS_MODEL_DIMENSIONS": "invalid json"}
